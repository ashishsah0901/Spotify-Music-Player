...
//This is the actual music service. Here we first get the media session. store the media token, and assign the playback
// preparer notification listeners. In onLoadChildren we can get all the songs from the source and display it.
@AndroidEntryPoint
class MusicService : MediaBrowserServiceCompat() {
    ...
    private fun preparePlayer(
        ...
        if(curSongIndex >= songs.size) curSongIndex = 1
