...
//This is used to get the songs from the firebase and and convert it to various desired forms. It also has the function
//to maintain the state whether the data is downloaded or not if not it maintains a list of lambda functions which will
//be triggered when the data is downloaded completely.
